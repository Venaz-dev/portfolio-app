...
export default function ImageSlider() {
  ...
  let skills = null;
  if (info.length > 0) {
    skills = info[0].skills.map((skill) => <p className="skill">{skill}</p>);
  }
      ...
      <div className="slider-container">
        <div className="project-details-container">
          <div className="project-details">
            <h1>{info.length > 0 ? info[0].title : null}</h1>
            ...
            <div className="project-links">
              <a
                className="link"
                href={info.length > 0 ? info[0].live_link : null}
              >
                Go to Site
              </a>
              <a
                className="link"
                href={info.length > 0 ? info[0].github_link : null}
              >
                Code on Github
              </a>
            </div>
